...
│   ├── frame-extraction.manifest.yaml           ← pack for the above
...
(``frame-extraction``) + MegaSaM-only tracker
...
```yaml
pack_dirs:
  - /cloud/cloud-ssd1/Kiri4DGS/sharp-4dgs/per-frame/frame-extraction.manifest.yaml
